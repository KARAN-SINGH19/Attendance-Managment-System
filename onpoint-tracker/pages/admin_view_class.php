             ...
             ORDER BY
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="admin_edit_attendance.php?class_id=<?php echo $attendance[0] ?>">Edit</a>
                            </td>
                            <td>
                                <a class="btn btn-outline-primary" href="admin_view_attendance.php?class_id=<?php echo $attendance[0] ?>">View</a>
                            </td>
                        </tr>
