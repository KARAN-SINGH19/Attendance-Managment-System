        ...
        if ($_SESSION["role_name"] == "Teacher") { ?>
            <section class="container">
                ...
                <div class="grid mt-5">
                    ...
                    $select_query = "SELECT module_id,module_name,user_fname,user_lname,course_name FROM module,user,course where module.module_tutor_id=$tutor_id and user.user_id=module.module_tutor_id and module.module_course_id=course.course_id";
